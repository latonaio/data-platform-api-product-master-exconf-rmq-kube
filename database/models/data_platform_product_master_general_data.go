...
var DataPlatformProductMasterGeneralDatumWhere = struct {
	...
	GrossWeight:          whereHelpernull_String{field: "`data_platform_product_master_general_data`.`GrossWeight`"},
	...
	NetWeight:            whereHelpernull_String{field: "`data_platform_product_master_general_data`.`NetWeight`"},
}
...
var (
	dataPlatformProductMasterGeneralDatumAllColumns            = []string{"Product", "ProductType", "BaseUnit", "ValidityStartDate", "ProductGroup", "Division", "GrossWeight", "WeightUnit", "SizeOrDimensionText", "IndustryStandardName", "ProductStandardID", "CreationDate", "LastChangeDate", "IsMarkedForDeletion", "NetWeight"}
	dataPlatformProductMasterGeneralDatumColumnsWithoutDefault = []string{"Product", "ProductType", "BaseUnit", "ValidityStartDate", "ProductGroup", "Division", "GrossWeight", "WeightUnit", "SizeOrDimensionText", "IndustryStandardName", "ProductStandardID", "CreationDate", "LastChangeDate", "IsMarkedForDeletion", "NetWeight"}
